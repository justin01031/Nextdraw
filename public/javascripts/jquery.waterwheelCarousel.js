...
(function ($) {
  ...
  $.fn.waterwheelCarousel = function (options) {
    ...
    return $(this).each(function () {
      ...
      function setupStarterRotation() {
        ...
        options.startingItem = (options.startingItem === 0) ? Math.round(data.totalItems) : options.startingItem;
  ...
  $.fn.waterwheelCarousel.defaults = {
    ...
    startingItem:               0,      // item to place in the center at the start, set to zero to be the last item
